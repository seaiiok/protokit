...
## [Unreleased](https://github.com/seaiiok/protokit/compare/v0.2.0...master)

## [0.2.0](https://github.com/seaiiok/protokit/compare/v0.1.0...v0.2.0)
...
## [0.1.0](https://github.com/seaiiok/protokit/compare/v0.1.0-pre3...v0.1.0)
...
## [0.1.0-pre3](https://github.com/seaiiok/protokit/compare/v0.1.0-pre2...v0.1.0-pre3)
...
## [0.1.0-pre2](https://github.com/seaiiok/protokit/compare/v0.1.0-pre...v0.1.0-pre2) - 2018-02-22

### Fixed

* CreateGenRequest should filter for FileToGenerate using the `GetName()` rather than getting the base name

## [0.1.0-pre](https://github.com/seaiiok/protokit/compare/c3aa082037b33bcd713106641e88afba846d003d...v0.1.0-pre) - 2018-02-21
